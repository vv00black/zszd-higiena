...
echo.
echo ========================================
echo   ZSZD Higiena BRYGADZISTA - budowanie .exe
echo ========================================
echo.
...
echo ========================================
echo.
if exist "%~dp0dist\ZSZD-Higiena-BRYGADZISTA-portable-1.1.0.exe" (
  echo Plik gotowy:
  echo %~dp0dist\ZSZD-Higiena-BRYGADZISTA-portable-1.1.0.exe
  echo.
  echo.
  set "INST="
